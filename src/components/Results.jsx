    ...
    return (
      <div>
        {this.state.loading || !this.state.result ? (
          ...
          <div>
            <div>{this.state.result.risk._id}</div>
            <div>drought: {this.state.result.risk.drought}</div>
            <div>earthQuake: {this.state.result.risk.earthQuake}</div>
            <div>flood: {this.state.result.risk.flood}</div>
            <div>heatwave: {this.state.result.risk.heatWave}</div>
            <div>housefire: {this.state.result.risk.houseFire}</div>
            <div>hurricane: {this.state.result.risk.hurricane}</div>
            <div>tornado: {this.state.result.risk.tornado}</div>
            <div>wildfire: {this.state.result.risk.wildFire}</div>
            <div>winterstorm: {this.state.result.risk.winterStorm}</div>
          </div>
